...
const DynamoDB = __nccwpck_require__(7124);
...
__nccwpck_require__(4908);
var AWS = __nccwpck_require__(5752);
...
Object.defineProperty(apiLoader.services['cognitoidentity'], '2014-06-30', {
  get: function get() {
    var model = __nccwpck_require__(4629);
    model.paginators = (__nccwpck_require__(1617)/* .pagination */ .o);
    return model;
  },
  enumerable: true,
  configurable: true
...
__nccwpck_require__(2500);
Object.defineProperty(apiLoader.services['dynamodb'], '2011-12-05', {
  get: function get() {
    var model = __nccwpck_require__(1367);
    model.paginators = (__nccwpck_require__(4545)/* .pagination */ .o);
    model.waiters = (__nccwpck_require__(2486)/* .waiters */ .V);
    return model;
  },
  enumerable: true,
  configurable: true
...
Object.defineProperty(apiLoader.services['dynamodb'], '2012-08-10', {
  get: function get() {
    var model = __nccwpck_require__(8385);
    model.paginators = (__nccwpck_require__(5325)/* .pagination */ .o);
    model.waiters = (__nccwpck_require__(8711)/* .waiters */ .V);
    return model;
  },
  enumerable: true,
  configurable: true
...
__nccwpck_require__(5486);
Object.defineProperty(apiLoader.services['sts'], '2011-06-15', {
  get: function get() {
    var model = __nccwpck_require__(9103);
    model.paginators = (__nccwpck_require__(7771)/* .pagination */ .o);
    return model;
  },
  enumerable: true,
  configurable: true
...
var AWS = __nccwpck_require__(5752);
__nccwpck_require__(1289);
__nccwpck_require__(9192);
 ...
 */
var AWS = { util: __nccwpck_require__(6322) };
...
AWS.util.update(AWS, {
   ...
   */
  Protocol: {
    Json: __nccwpck_require__(4900),
    Query: __nccwpck_require__(405),
    Rest: __nccwpck_require__(5906),
    RestJson: __nccwpck_require__(2758),
    RestXml: __nccwpck_require__(6826)
  },
   ...
   */
  XML: {
    Builder: __nccwpck_require__(8166),
   ...
   */
  JSON: {
    Builder: __nccwpck_require__(6541),
   ...
   */
  Model: {
    Api: __nccwpck_require__(2118),
    Operation: __nccwpck_require__(6637),
    Shape: __nccwpck_require__(9776),
    Paginator: __nccwpck_require__(6901),
    ResourceWaiter: __nccwpck_require__(7803)
  },

  /**
   * @api private
   */
  apiLoader: __nccwpck_require__(1703),

  /**
   * @api private
   */
  EndpointCache: (__nccwpck_require__(3764)/* .EndpointCache */ .$)
});
__nccwpck_require__(1977);
__nccwpck_require__(3284);
__nccwpck_require__(8558);
__nccwpck_require__(7791);
__nccwpck_require__(7795);
__nccwpck_require__(5152);
__nccwpck_require__(9842);
__nccwpck_require__(6194);
__nccwpck_require__(3000);
__nccwpck_require__(2588);
__nccwpck_require__(8364);
...
var AWS = __nccwpck_require__(5752);
var STS = __nccwpck_require__(6818);
...
var AWS = __nccwpck_require__(5752);
var CognitoIdentity = __nccwpck_require__(3572);
var STS = __nccwpck_require__(6818);
...
var AWS = __nccwpck_require__(5752);
var util = __nccwpck_require__(6322);
...
var AWS = __nccwpck_require__(5752);
var util = AWS.util;
var typeOf = (__nccwpck_require__(7724).typeOf);
var DynamoDBSet = __nccwpck_require__(2129);
var NumberValue = __nccwpck_require__(8710);
...
var AWS = __nccwpck_require__(5752);
var Translator = __nccwpck_require__(9769);
var DynamoDBSet = __nccwpck_require__(2129);
...
var util = (__nccwpck_require__(5752).util);
...
var util = (__nccwpck_require__(5752).util);
var convert = __nccwpck_require__(8799);
...
var eventMessageChunker = (__nccwpck_require__(993).eventMessageChunker);
var parseEvent = (__nccwpck_require__(8354).parseEvent);
...
var parseMessage = (__nccwpck_require__(4953).parseMessage);
...
var Int64 = (__nccwpck_require__(1941).Int64);

var splitMessage = (__nccwpck_require__(3850).splitMessage);
...
var EventMessageChunkerStream = (__nccwpck_require__(1109).EventMessageChunkerStream);
var EventUnmarshallerStream = (__nccwpck_require__(1623).EventUnmarshallerStream);
...
var AWS = __nccwpck_require__(5752);
var SequentialExecutor = __nccwpck_require__(1977);
var DISCOVER_ENDPOINT = (__nccwpck_require__(3639).discoverEndpoint);
/**
...
AWS.EventListeners = {
  ...
  Logger: new SequentialExecutor().addNamedListeners(function(add) {
    add('LOG_REQUEST', 'complete', function LOG_REQUEST(resp) {
      ...
      function buildMessage() {
        ...
        var params = (__nccwpck_require__(3837).inspect)(censoredParams, true, null);
        var message = '';
  ...
  Json: new SequentialExecutor().addNamedListeners(function(add) {
    var svc = __nccwpck_require__(4900);
  ...
  Rest: new SequentialExecutor().addNamedListeners(function(add) {
    var svc = __nccwpck_require__(5906);
    add('BUILD', 'build', svc.buildRequest);
    add('EXTRACT_DATA', 'extractData', svc.extractData);
    add('EXTRACT_ERROR', 'extractError', svc.extractError);
  }),
  ...
  RestJson: new SequentialExecutor().addNamedListeners(function(add) {
    var svc = __nccwpck_require__(2758);
    add('BUILD', 'build', svc.buildRequest);
    add('EXTRACT_DATA', 'extractData', svc.extractData);
    add('EXTRACT_ERROR', 'extractError', svc.extractError);
  ...
  RestXml: new SequentialExecutor().addNamedListeners(function(add) {
    var svc = __nccwpck_require__(6826);
    add('BUILD', 'build', svc.buildRequest);
    add('EXTRACT_DATA', 'extractData', svc.extractData);
    add('EXTRACT_ERROR', 'extractError', svc.extractError);
  }),
  ...
  Query: new SequentialExecutor().addNamedListeners(function(add) {
    var svc = __nccwpck_require__(405);
    add('BUILD', 'build', svc.buildRequest);
    add('EXTRACT_DATA', 'extractData', svc.extractData);
    add('EXTRACT_ERROR', 'extractError', svc.extractError);
  })
...
AWS.NodeHttpClient = AWS.util.inherit({
  handleRequest: function handleRequest(httpRequest, httpOptions, callback, errCallback) {
    ...
    var http = useSSL ? __nccwpck_require__(5687) : __nccwpck_require__(3685);
    var options = {
...
__nccwpck_require__(7791);
var inherit = AWS.util.inherit;
var getMetadataServiceEndpoint = __nccwpck_require__(9933);
...
var EndpointMode = __nccwpck_require__(8564)();
...
var Endpoint = __nccwpck_require__(7587)();
var EndpointMode = __nccwpck_require__(8564)();

var ENDPOINT_CONFIG_OPTIONS = __nccwpck_require__(7677)();
var ENDPOINT_MODE_CONFIG_OPTIONS = __nccwpck_require__(3330)();
...
var Collection = __nccwpck_require__(6041);
var Operation = __nccwpck_require__(6637);
var Shape = __nccwpck_require__(9776);
var Paginator = __nccwpck_require__(6901);
var ResourceWaiter = __nccwpck_require__(7803);
var metadata = __nccwpck_require__(1409);
...
var memoizedProperty = (__nccwpck_require__(6322).memoizedProperty);
...
var property = (__nccwpck_require__(6322).property);
...
var region_utils = __nccwpck_require__(5837);
...
util.createEventStream = util.stream.Readable ?
  (__nccwpck_require__(527).createEventStream) : (__nccwpck_require__(6160).createEventStream);
util.realClock = __nccwpck_require__(4100);
util.clientSideMonitoring = {
  Publisher: (__nccwpck_require__(1352).Publisher),
  configProvider: __nccwpck_require__(751),
};
util.iniLoader = (__nccwpck_require__(5043)/* .iniLoader */ .b);
 ...
 * @api private
 */
module.exports = AWS = __nccwpck_require__(5752);

__nccwpck_require__(1289);
__nccwpck_require__(9192);
__nccwpck_require__(3254);
__nccwpck_require__(6066);
__nccwpck_require__(430);
__nccwpck_require__(3656);
__nccwpck_require__(9350);
__nccwpck_require__(2347);

// Load the xml2js XML parser
AWS.XML.Parser = __nccwpck_require__(2126);

// Load Node HTTP client
__nccwpck_require__(5883);

__nccwpck_require__(9920);

// Load custom credential providers
__nccwpck_require__(8720);
__nccwpck_require__(8438);
__nccwpck_require__(2380);
__nccwpck_require__(7192);
__nccwpck_require__(1060);
__nccwpck_require__(4384);
__nccwpck_require__(908);
__nccwpck_require__(2347);
__nccwpck_require__(8256);
...
var util = __nccwpck_require__(6322);
var JsonBuilder = __nccwpck_require__(6541);
var JsonParser = __nccwpck_require__(3280);
var populateHostPrefix = (__nccwpck_require__(4925).populateHostPrefix);
...
var AWS = __nccwpck_require__(5752);
var util = __nccwpck_require__(6322);
var QueryParamSerializer = __nccwpck_require__(1470);
var Shape = __nccwpck_require__(9776);
var populateHostPrefix = (__nccwpck_require__(4925).populateHostPrefix);
...
var util = __nccwpck_require__(6322);
var Rest = __nccwpck_require__(5906);
var Json = __nccwpck_require__(4900);
var JsonBuilder = __nccwpck_require__(6541);
var JsonParser = __nccwpck_require__(3280);
...
var util = __nccwpck_require__(6322);
var regionConfig = __nccwpck_require__(864);
...
var AWS = __nccwpck_require__(5752);
var AcceptorStateMachine = __nccwpck_require__(7575);
var inherit = AWS.util.inherit;
var domain = AWS.util.domain;
var jmespath = __nccwpck_require__(5566);
...
var AWS = __nccwpck_require__(5752);
var Api = __nccwpck_require__(2118);
var regionConfig = __nccwpck_require__(3207);
...
var AWS = __nccwpck_require__(5752);
var resolveRegionalEndpointsFlag = __nccwpck_require__(7408);
...
var IniLoader = (__nccwpck_require__(9920).IniLoader);
/**
...
__nccwpck_require__(5761);
__nccwpck_require__(9279);
__nccwpck_require__(4586);
__nccwpck_require__(8515);
__nccwpck_require__(2903);
__nccwpck_require__(7354);
__nccwpck_require__(9795);
...
var AWS = __nccwpck_require__(5752);
var v4Credentials = __nccwpck_require__(106);
var inherit = AWS.util.inherit;
...
var util = {
  ...
  userAgent: function userAgent() {
    ...
    var agent = 'aws-sdk-' + name + '/' + (__nccwpck_require__(5752).VERSION);
  ...
  readFileSync: function readFileSync(path) {
    ...
    return (__nccwpck_require__(7147).readFileSync)(path, 'utf-8');
  },
  ...
  string: {
    byteLength: function byteLength(string) {
      ...
      if (typeof string.byteLength === 'number') {
        ...
        return (__nccwpck_require__(7147).lstatSync)(string.path).size;
      } else {
  ...
  date: {
    ...
    getDate: function getDate() {
      if (!AWS) AWS = __nccwpck_require__(5752);
  ...
  uuid: {
    v4: function uuidV4() {
      return (__nccwpck_require__(6785).v4)();
    }
  },
...
var util = __nccwpck_require__(6322);
var XmlNode = (__nccwpck_require__(8604).XmlNode);
var XmlText = (__nccwpck_require__(7977).XmlText);
...
var xml2js = __nccwpck_require__(9907);
...
var escapeAttribute = (__nccwpck_require__(5450).escapeAttribute);
...
var escapeElement = (__nccwpck_require__(7280).escapeElement);
...
var LRU_1 = __nccwpck_require__(4184);
var CACHE_SIZE = 1000;
/**
...
var _v2 = _interopRequireDefault(__nccwpck_require__(8974));

var _v3 = _interopRequireDefault(__nccwpck_require__(5653));

var _v4 = _interopRequireDefault(__nccwpck_require__(6651));
...
var _rng = _interopRequireDefault(__nccwpck_require__(2016));

var _bytesToUuid = _interopRequireDefault(__nccwpck_require__(4781));
...
var _md = _interopRequireDefault(__nccwpck_require__(860));
...
(function() {
  ...
  builder = __nccwpck_require__(1494);

  defaults = (__nccwpck_require__(3532).defaults);
...
(function() {
  ...
  sax = __nccwpck_require__(8407);

  events = __nccwpck_require__(2361);

  bom = __nccwpck_require__(2577);

  processors = __nccwpck_require__(8295);
...
(function() {
  ...
  defaults = __nccwpck_require__(3532);

  builder = __nccwpck_require__(3844);

  parser = __nccwpck_require__(4679);
...
(function() {
  ...
  XMLNode = __nccwpck_require__(2172);
...
(function() {
  ...
  isObject = (__nccwpck_require__(8102).isObject);
...
(function() {
  ...
  XMLDTDAttList = __nccwpck_require__(3277);

  XMLDTDEntity = __nccwpck_require__(5774);

  XMLDTDElement = __nccwpck_require__(9656);

  XMLDTDNotation = __nccwpck_require__(2351);
...
(function() {
  ...
  isPlainObject = (__nccwpck_require__(8102).isPlainObject);

  XMLNode = __nccwpck_require__(2172);

  XMLStringifier = __nccwpck_require__(861);

  XMLStringWriter = __nccwpck_require__(5914);
...
(function() {
  ...
  ref = __nccwpck_require__(8102), isObject = ref.isObject, isFunction = ref.isFunction, isPlainObject = ref.isPlainObject;

  XMLElement = __nccwpck_require__(3001);

  XMLCData = __nccwpck_require__(8810);

  XMLComment = __nccwpck_require__(7670);

  XMLRaw = __nccwpck_require__(134);

  XMLText = __nccwpck_require__(8365);

  XMLProcessingInstruction = __nccwpck_require__(4009);

  XMLDeclaration = __nccwpck_require__(7424);

  XMLDocType = __nccwpck_require__(225);
  ...
  XMLAttribute = __nccwpck_require__(4634);
...
(function() {
  ...
  ref = __nccwpck_require__(8102), isObject = ref.isObject, isFunction = ref.isFunction;
...
(function() {
  ...
  ref = __nccwpck_require__(8102), isObject = ref.isObject, isFunction = ref.isFunction, isEmpty = ref.isEmpty;
...
(function() {
  ...
  XMLWriterBase = __nccwpck_require__(9308);
...
(function() {
  ...
  ref = __nccwpck_require__(8102), assign = ref.assign, isFunction = ref.isFunction;

  XMLDocument = __nccwpck_require__(5549);

  XMLDocumentCB = __nccwpck_require__(9189);

  XMLStringWriter = __nccwpck_require__(5914);

  XMLStreamWriter = __nccwpck_require__(1162);
...
const {APIDB} = __nccwpck_require__(7129);
